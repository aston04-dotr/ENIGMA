...
6.5.1. Стоимость платных функций на Платформе ENIGMA (актуально на май 2026 г.):

Размещение объявлений:

Обычное размещение и одновременная активность до 15 (пятнадцати) объявлений доступны пользователю без отдельной платы за размещение (в любых доступных категориях и регионах интерфейса). Платёж становится возможным только при желании пользователя расширить лимит одновременных активных объявлений.

Платные пакеты расширения лимита (дополнительные одновременно активные объявления сверх бесплатных 15):

+25 активных объявлений к лимиту: 2 900 ₽

+50 активных объявлений к лимиту: 4 900 ₽

+100 активных объявлений к лимиту: 7 900 ₽

Продвижение объявлений (отдельно от расширения лимита):
